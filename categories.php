...
<!-- this/categories.php created, Sun, 05 Aug 2018 11:38:45 GMT -->
<head>
		...
		<header class="header">
			<div class="container clearfix">
				<div class="header-inner flex space-between items-center">
					<div class="left">
						<div class="logo"><a href="index-2.php"><img src="images/logo.png" alt="JobPress" class="img-responsive"></a></div>	
					</div> <!-- end .left -->				
						...
						<div class="navigation">
							<nav class="main-nav">
								<ul class="list-unstyled">
                                    ...
                                    <li><a href="candidate-dashboard.php">Profile</a></li>
...
<!-- this/categories.php created, Sun, 05 Aug 2018 11:38:52 GMT -->
</html>