				...
				<div class="container">
					<div class="contact-us-section-inner flex space-between no-wrap">
						<div class="left">
							...
							<p class="ultra-light">Feel free to contact us.</p>
							 <!-- end .follow-us -->
						</div> <!-- end .left -->
							...
							<form action="contact.php" method="post"  class="contact-form">
								<div class="form-group-wrapper flex space-between items-center">
									<div class="form-group">
										...
										<input type="text" id="contact-name" name="naam" placeholder="Enter your name" required="">
									</div> <!-- end .form-group -->
									<div class="form-group">
										<p class="label">Your Email*</p>
										<input type="email" id="contact-email" name="mail" placeholder="Enter your email" required="">
									</div> <!-- end .form-group -->
								</div> <!-- end .form-group-wrapper -->
                                    
									<div class="form-group textarea">
										<p class="label">Your Message*</p>
										<textarea name="msg" id="contact-message" required="" rows="6" placeholder="Here goes your message"></textarea>
									</div> <!-- end .form-group -->
									<button type="submit" class="button" name="submitBtn">Send us</button>
