...
$query = mysql_query("SELECT * FROM resume WHERE emp_id=$id ");
...
<head>
	...
	<body>
	            ...
	            <div class="modal-content">
	                ...
	                <div class="modal-body">
	                    <div class="tab-content" id="myTabContent">
							...
							<?php  if($skill=="Marketing" OR $skill=="Chess" OR $skill=="Sales")
							{
							?>	
								<!-- Post Job Section -->
				...
				<div class="container">
					<!-- multistep form -->
								...
								<div class="form-inner">
					    					<p><h4 class="form-fields-title dark">task 3-Lead atleast one project on National level .</h4></p>	    		
      ...
      <input type="checkbox" value="1" name="tick">completed
    </label>
										</div> <!-- end .form-group -->
									</div> <!-- end .form-group-wrapper -->

								</div> <!-- end .form-field-wrapper -->
			<form action="taskinc.php" method="post" id="job-post-form" class="job-post-form multisteps-form">
								<div class="divider"></div>
				<input type="hidden" value="<?php echo $id;?> name="idea">	
					    		<div class="button-wrapper text-center">
					    			
					    			<!--button type="submit" class="btn btn-primary" name="action">Next</button-->
			...
			<div class="inner">
				<div class="container">
					<!-- multistep form -->
					  	...
					  	<fieldset>
						  	<h2 class="form-title text-center dark">Task 3</h2>
			...
			<div class="inner">
				<div class="container">
					<!-- multistep form -->
								...
								<div class="form-inner">
					    					<p><h4 class="form-fields-title dark">task 3-Deploy 25 test cases(DURATION 1 week.)</h4></p>	    		
								<div class="divider"></div>
								...
								<div class="form-fields-wrapper">
									...
									<form action="taskinc.php" method="post" id="job-post-form" class="job-post-form multisteps-form">	
										<div class="form-group">
											<p class="label"> <br></p>
											<label class="checkbox-inline">
      <input type="checkbox" value="" name="tick">completed
    </label>
										</div> <!-- end .form-group -->
									</div> <!-- end .form-group-wrapper -->
