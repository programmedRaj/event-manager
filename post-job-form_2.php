	...
	<body>
		...
		<div class="section job-post-form-section solid-light-grey-bg">
			<div class="inner">
				<div class="container">
					<!-- multistep form -->
					<form action="post-job-formaction.php" method="post" id="job-post-form" class="job-post-form multisteps-form">
					  	...
					  	<fieldset>
						    ...
						    <h3 class="step-title text-center dark">Step 2: Event Details</h2>
					    	...
					    	<div class="form-inner">
								...
								<div class="form-fields-wrapper">
									<h4 class="form-fields-title dark">Event Info:</h4>
									<div class="form-group-wrapper flex space-between items-center">
										<div class="form-group">
											<p class="label">Event name</p>
											<input type="text" id="employer-company-name" name="cn" placeholder="" required="">
										</div> <!-- end .form-group -->
									...
									<div class="form-group-wrapper flex space-between items-center">
										<div class="form-group">
											<p class="label">Phone Number<sup>*</sup><span> (Will not be displayed on the website)</span></p>
											<input type="tel" id="" name="cnum" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required="" placeholder="123-456-7890">
										</div> <!-- end .form-group -->
										<div class="form-group">
									...
									<div class="form-group-wrapper">
										<div class="form-group">
											...
											<textarea name="cdesc" id="cdesc" required="" rows="6" placeholder=""></textarea>
										</div> <!-- end .form-group -->
									</div> <!-- end .form-group-wrapper -->
								...
								<div class="form-fields-wrapper">
									<h4 class="form-fields-title dark">Event Details</h4>
									<div class="form-group-wrapper">
										<div class="form-group">
									...
									<div class="form-group-wrapper flex space-between items-center">
										<div class="form-group">
											<p class="label">Event category</p>
											<select name="jtype" class="form-control" id="job-type-filter">
									...
									<div class="form-group-wrapper flex space-between items-center">
                                        ...
                                        <div class="form-group">
											...
											<input type="date" id="job-salary" name="expdate" placeholder="" required="">
					    		...
					    		<div class="button-wrapper text-center">
					    			<a href="post-job-form.php"><button type="button" class="btn previous btn-primary">Back</button></a>
