				...
				<div class="container">
					<!-- multistep form -->
								...
								<div class="form-inner">
					    					<p><h4 class="form-fields-title dark">task 2-Get 30 clients or more (DURATION 3 weeks.)</h4></p>	    		
			...
			<div class="inner">
				<div class="container">
					<!-- multistep form -->
					  	...
					  	<fieldset>
						  	<h2 class="form-title text-center dark">Task 2</h2>
			...
			<div class="inner">
				<div class="container">
					<!-- multistep form -->
								...
								<div class="form-inner">
					    					<p><h4 class="form-fields-title dark">task 2-Provide 3 Full stack algorithm designs (duration - 2 weeks)</h4></p>	    		
								<div class="divider"></div>
